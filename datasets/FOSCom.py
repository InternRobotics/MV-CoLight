...
@DATASETS.register_module("FOSComEval")
class FOSComEvalDataset(Dataset):
    def __init__(
        self,
        data_json, 
        num_context_views=1,
        ...
        data_dict = json.load(open(self.data_json, 'r'))["foscom"]
    ...
    def getitem(self, index):
        ...
        context_bg_image = load_image(os.path.join(self.data_root, example["bg_path"])).unsqueeze(0)
